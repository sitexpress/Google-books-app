...
export type BooksCategoryType = "all" | "art" | "biography" | "computer" | "history" | "medical" | "poetry"

export type BooksRelevanceType = "relevance" | "newest"
export interface ErrorMessageType {
    message: string
}
export interface BookSearchingSliceExtendedType extends BookSearchingSliceType {
    page: number
    query: string
